...
import {styles} from './bar_chart_vis.css';


/**
 * Bar chart visualization component.
 */
@customElement('bar-chart-vis')
export class BarChartVis extends ReactiveElement {
    ...
    return html`
      <div id="holder">
        ${this.isLoading ? this.renderSpinner(): ''}
          <svg class=${classMap({'loading': this.isLoading})} id="chart"></svg>
